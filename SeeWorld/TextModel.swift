...
//                        self.basicModel.textToSpeech(resultOutput)
//                    }
//                    break
//
//                case .failure(_):
...
//            self.basicModel.textToSpeech("The time is " + dateInFormat)
//            break
//
//        case "temperature":
...
//            self.basicModel.textToSpeech("You choose Uber, We will leave the app")
//            DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + Double(Int64(3*NSEC_PER_SEC))/Double(NSEC_PER_SEC)) {
...
//            self.basicModel.textToSpeech("You choose walk, We will leave the app")
//
//            DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + Double(Int64(3*NSEC_PER_SEC))/Double(NSEC_PER_SEC)) {
//                let myLocation = CLLocationCoordinate2D(latitude: self.mapModel._latEnd, longitude: self.mapModel._lonEnd)
//                //self.mapModel.openInMapsTransit(coord: myLocation)
...
//            self.basicModel.textToSpeech("You choose bus, We will leave the app")
//            DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + Double(Int64(3*NSEC_PER_SEC))/Double(NSEC_PER_SEC)) {
//                let myLocation = CLLocationCoordinate2D(latitude: self.mapModel._latEnd, longitude: self.mapModel._lonEnd)
//                //self.mapModel.openInMapsTransit(coord: myLocation)
//            }
...
//            self.basicModel.textToSpeech("Sorry, Please speak again!")
//            break
//        }
//    }
